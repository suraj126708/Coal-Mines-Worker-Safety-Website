    ...
    <div className="bg-gray-100 flex flex-col items-center justify-center my-5 text-gray-800">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-4/5 md:w-2/3 lg:w-1/2">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Worker Info */}
          <h2 className="text-3xl font-bold mb-2">{user.worker[0].name}</h2>
          ...
          <p className="text-gray-700 text-lg">
            John has been outstanding in his attendance and safety compliance.
            He has followed all safety protocols and encouraged others to do the
            same.
          </p>
        </div>
      </div>
