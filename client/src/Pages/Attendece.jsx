...
const Attendance = ({ setIsAuthorised }) => {
  ...
  const coalMinesBoundary = {
    latMin: 20.82637381495903,
    latMax: 30.875380187418823,
    lngMin: 74.49635090346976,
    lngMax: 90.55104193956842,
  };
  ...
  return (
    <>
      <NavBar id="black" setIsAuthorised={setIsAuthorised} />
